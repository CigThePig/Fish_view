...
export const STEERING_FIELDS = Object.freeze([
  ...
  field("maximumSpeed", "Maximum speed", "rows/s ceiling", 0.05, 4, 0.01),
...
export const SCENE_FIELDS = Object.freeze({
  ...
  "playful-chase": Object.freeze([
    ...
    field("lungeSpeedGain", "Chaser lunge", "rows/s added at the top of each lunge", 0, 2, 0.005),
    ...
    field("evasionBurstGain", "Evader dodge burst", "rows/s added at the top of the dodge pulse", 0, 2, 0.005),
