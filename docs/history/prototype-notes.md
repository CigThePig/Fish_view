# Retired prototype notes

Historical snapshot before the horizontal-only decision. Portrait, Compare, orientation controls, associated budgets and commands below are retired. The [current README](../../README.md) defines the product. Relative asset links below refer to the former repository-root document.
